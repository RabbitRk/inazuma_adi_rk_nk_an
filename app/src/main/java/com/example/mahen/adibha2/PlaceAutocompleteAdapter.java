...
public class PlaceAutocompleteAdapter extends RecyclerView.Adapter<PlaceAutocompleteAdapter.PlaceViewHolder> implements Filterable {
        ...
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                if (results != null && results.count > 0) {
                    ...
                    Log.i("Response__publish", "Starting autocomplete query for: " + constraint);
    ...
    private ArrayList<PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            Log.i("Response", "Starting autocomplete query for: " + constraint);
            ...
            if (!status.isSuccess()) {
                Log.e("Response", "Error getting autocomplete prediction API call: " + status.toString());
                autocompletePredictions.release();
                return null;
            }

            Log.i("Response", "Query completed. Received " + autocompletePredictions.getCount()
                    + " predictions.");
        ...
        Log.e("Response", "Google API client is not connected for autocomplete query.");
        return null;
    }
    ...
    public void onBindViewHolder(@NonNull PlaceViewHolder mPredictionHolder, final int i) {
        ...
        Log.i("Response", "Responce_bindviewholder");
